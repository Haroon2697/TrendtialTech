...
const Feature = ({ title, description }: FeatureProps) => (
  ...
  >
    ...
    <p className="text-gray-400 text-sm md:text-[13px] leading-relaxed">
      {description}
    </p>
  </motion.div>
);
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10 mb-24">
        ...
        <motion.div 
          className="h-px bg-gray-800 w-full mb-6"
          variants={dividerVariants}
        />
        
        <motion.h3 
          className="text-2xl md:text-3xl font-extralight mb-8 text-indigo-400" 
          variants={itemVariants}
        >
        ...
        <motion.h3 
          className="text-2xl md:text-3xl font-extralight mb-6 text-indigo-400" 
          variants={itemVariants}
        >
          Proven Track Record
        </motion.h3>
