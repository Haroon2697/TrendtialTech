    ...
    <div className="w-full bg-[#020824] text-white relative overflow-hidden font-[Manrope,sans-serif]">
      ...
      >
        <div className="space-y-6 md:mr-12 text-center md:text-left" ref={firstTextRef}>
          <motion.h2
            className="text-xl sm:text-2xl md:text-4xl lg:text-[42px] font-medium leading-tight bg-clip-text text-transparent bg-gradient-to-r from-[#ffffff] to-[#00f2fe]"
      ...
      >
        ...
        <div className="space-y-6 md:ml-12 text-center md:text-left" ref={secondTextRef}>
          <motion.h2
            className="text-xl sm:text-2xl md:text-3xl lg:text-[36px] font-medium leading-tight bg-clip-text text-transparent bg-gradient-to-r from-[#ffffff] to-[#38f9d7]"
            initial={{ opacity: 0, x: 50 }}
